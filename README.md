...
- Single-day modal detail (with neighbourhood filter).
...
4. Choose the activity type and time-of-day filters.
5. Optionally use your current location or pick a spot on the map to filter by distance.
